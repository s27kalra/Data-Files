...
--Add foriegn key to shops tabel
ALTER Table shops
...
--Now set the coffeshop_id for the first two employees we inserted as 1
Update employees
Set Coffeeshop_Id = 1
Where Employee_id  IN (501559, 144100)

--Insert Los Angeles into locations table
...
Select first_name, last_name, email_id from employees
Select CoffeeShop_Id, supplier_name from suppliers

--Where Clause + AND & OR

--Select only employees whoes salary is > 50K
Select * from employees 
where salary > 50000;
...
--Select all the employees who work in common ground or make more than 50K
Select * from employees 
where coffeeshop_id = 1 
OR salary > 50000

--Select all the employees who work in common grounDS, make more than 50K and are Males
Select * from employees 
where coffeeshop_id = 1 
AND salary > 50000
AND gender = 'M'
...
--Select all rows from suppliers table where supplier is not 'Beans and Barle'
Select * from suppliers
Where Not Supplier_name = 'Beans and Barley'

--Select all Robusta and Arabica coffe Types
Select * from suppliers
Where coffee_type IN ('Robusta', 'Arabica')

--Select all coffe types that are not Robusta and Arabica coffe Types
Select * from suppliers
...
--Select all employees whoes email_id is not missing
SELECT * FROM employeeS
WHERE email_id IS NOT NULL

--Select all employess whom make between 30k and 50k
Select * FROM employees
Where Salary 
Between 30000 AND 50000

--Order By, Distinct, Limit, Renaming Columns
...
--Return all unique coffeshop_id from employees
Select Distinct coffeeshop_id
from employees;

--Return unique countris
